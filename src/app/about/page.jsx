...
export default function AboutPage() {
  ...
  const allTechs = techStack.flatMap((c) =>
    c.techs.map((t) => ({ ...t, category: c.category }))
  );
          ...
          <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
            ...
            <div className="lg:w-[55%]">
              ...
              >
                ...
                We&apos;re{" "}
                <span className="text-gradient font-bold">Arcyl Media</span>.
              </motion.h1>
              ...
              >
                {siteConfig.description} We combine elite digital marketing and premium web engineering with advanced AI automation to deliver growth solutions that make a lasting impact.
              </motion.p>
      ...
      <section ref={expertiseRef} className="section-spacing relative">
        ...
        <div className="section-container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {collaborativeExpertise.map((item, i) => {
