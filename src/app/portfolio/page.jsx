                  ...
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-[50%] p-8 lg:p-12 flex flex-col justify-between z-10 bg-dark-100/50 lg:bg-transparent">
                      <div>
                        <div className="flex items-start justify-between mb-6">
                          <div>
                            ...
                            <h3 className="text-white text-2xl sm:text-3xl font-semibold font-body mb-3 group-hover:text-primary transition-colors duration-300">
                              {project.title}
                            </h3>
                          ...
                          <a
                            ...
                            className="flex-shrink-0 ml-6 px-5 py-2.5 rounded-full bg-primary/10 border border-primary/20 text-primary hover:bg-primary hover:text-white transition-all duration-300 flex items-center gap-2 text-sm font-medium shadow-glow whitespace-nowrap"
                          >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 pt-8 border-t border-glass-border">
                          <div>
                            <h4 className="text-muted text-xs uppercase tracking-wider font-semibold mb-2">
                              Challenges
                            </h4>
                      ...
                      <div className="mt-8 pt-6 border-t border-glass-border">
                        <h4 className="text-muted text-xs uppercase tracking-wider font-semibold mb-3">
                          Technologies Used
                        </h4>
                        <div className="flex flex-wrap gap-2">
                          {project.technologies.map((tech) => (
                            <span
                              key={tech}
                              className="tech-badge text-xs px-3 py-1.5 rounded-full bg-dark-200 border border-glass-border text-white/90"
                            >
                              {tech}
                            </span>
                          ))}
