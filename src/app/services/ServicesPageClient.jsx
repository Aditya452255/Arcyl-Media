...
export default function ServicesPageClient({ services, settings }) {
  ...
  const serviceList = services && services.length > 0 ? services.map(item => ({
    ...
    features: [
      ...
      "Tailored UX user workflows",
      "99.9% High Availability support"
    ]
  })) : serviceDetails;
        ...
        <div className="section-container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {whyChooseUs.map((item, i) => (
              ...
              >
                <h3 className="text-white text-xl font-semibold mb-4 font-body group-hover:text-primary transition-colors duration-300">
                  {item.title}
                </h3>
